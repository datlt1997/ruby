...
ActiveRecord::Schema[7.1].define(version: 2025_08_12_075333) do
  ...
  create_table "prizes", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "select_numbers", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "winners", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
